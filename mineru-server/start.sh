...
MINERU_API_TASK_RETENTION_SECONDS="${MINERU_API_TASK_RETENTION_SECONDS:-600}"
MINERU_API_TASK_CLEANUP_INTERVAL_SECONDS="${MINERU_API_TASK_CLEANUP_INTERVAL_SECONDS:-60}"
...
export MINERU_API_TASK_CLEANUP_INTERVAL_SECONDS
...
echo "Retenção de tarefas: ${MINERU_API_TASK_RETENTION_SECONDS}s."
echo "Intervalo de limpeza: ${MINERU_API_TASK_CLEANUP_INTERVAL_SECONDS}s."
